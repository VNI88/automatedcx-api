...
module Fugit::Nat
  def self.assemble_cron(h); end
  def self.do_parse(s, opts = nil); end
  def self.eone(e); end
  def self.parse(s, opts = nil); end
  def self.parse_at_elt(e, opts, h); end
  def self.parse_crons(s, a, opts); end
  def self.parse_day_of_month_elt(e, opts, h); end
  def self.parse_dow_list_elt(e, opts, h); end
  def self.parse_dow_range_elt(e, opts, h); end
  def self.parse_interval_elt(e, opts, h); end
  def self.parse_on_elt(e, opts, h); end
  def self.parse_tz_elt(e, opts, h); end
end
