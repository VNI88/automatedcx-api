...
class Prawn::Errors::InvalidJoinStyle < StandardError
end
...
class Prawn::Text::Formatted::LineWrap
  ...
  def break_chars(encoding = nil); end
  ...
  def scan_pattern(encoding = nil); end
  def soft_hyphen(encoding = nil); end
  def space_count; end
  ...
  def whitespace(encoding = nil); end
  def width; end
  def word_division_scan_pattern(encoding = nil); end
  def wrap_by_char(segment); end
  def wrap_line(options); end
  def zero_width_space(encoding = nil); end
end
...
class Prawn::Text::Formatted::Parser
  ...
  def self.format(string, *_args); end
...
module Prawn::Graphics
  ...
  def ellipse(point, radius1, radius2 = nil); end
...
module Prawn::Graphics::BlendMode
  def blend_mode(blend_mode = nil); end
...
module Prawn::Graphics::Transparency
  ...
  def transparent(opacity, stroke_opacity = nil); end
end
...
module Prawn::Graphics::Patterns
  ...
  def parse_gradient_arguments(*arguments, from: nil, to: nil, r1: nil, r2: nil, stops: nil, apply_transformations: nil); end
...
class Prawn::Document
  ...
  def init_bounding_box(user_block, options = nil); end
  def init_column_box(user_block, options = nil); end
...
module PDF::Core
  def encrypted_pdf_object(obj, key, id, gen, in_content_stream = nil); end
  def self.encrypted_pdf_object(obj, key, id, gen, in_content_stream = nil); end
end
...
module Prawn::TransformationStack
  ...
  def current_transformation_matrix_with_translation(x = nil, y = nil); end
...
class Prawn::Document::BoundingBox
  ...
  def document; end
  def height; end
  def indent(left_padding, right_padding = nil); end
...
module Prawn::Document::Internals
  ...
  def on_page_create(*args, &block); end
  def ref!(*args, &block); end
  def ref(*args, &block); end
  def renderer; end
  def restore_graphics_state; end
  def save_graphics_state(state = nil, &block); end
  extend Forwardable
end
...
class Prawn::Fonts::AFM < Prawn::Font
  ...
  def self.font_data; end
  def self.hide_m17n_warning; end
  def self.hide_m17n_warning=(arg0); end
...
module Prawn::View
  ...
  def respond_to_missing?(method_name, _include_all = nil); end
