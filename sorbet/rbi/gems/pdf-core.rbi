...
module PDF::Core
  def pdf_object(obj, in_content_stream = nil); end
  def real(num); end
  def real_params(array); end
  def self.pdf_object(obj, in_content_stream = nil); end
  def self.real(num); end
  def self.real_params(array); end
...
module PDF::Core::Filters::FlateDecode
  def self.decode(stream, _params = nil); end
  def self.encode(stream, _params = nil); end
end
...
module PDF::Core::Utils
  ...
  def self.deep_clone(object); end
end
...
module PDF::Core::Text
  ...
  def horizontal_text_scaling(amount = nil); end
