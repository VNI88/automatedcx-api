...
class Faraday::RequestOptions < Anonymous_Faraday_Options_53
  def []=(key, value); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_54
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_55
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_56
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_57
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_58
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
