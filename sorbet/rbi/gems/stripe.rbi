...
class Stripe::ConnectionManager
  ...
  def execute_request(method, uri, body: nil, headers: nil, query: nil); end
...
class Stripe::Instrumentation::RequestEndEvent
  def duration; end
  def http_status; end
  def initialize(duration:, http_status:, method:, num_retries:, path:, user_data: nil); end
  def method; end
  def num_retries; end
  def path; end
  def user_data; end
...
class Stripe::StripeResponse::Headers
  def [](name); end
